...
TEST_CASE("Print::print(int, int = DEC|HEX|OCT|BIN)", "[Print-print-04]")
{
  ...
  WHEN("HEX") { mock.print(val, HEX); REQUIRE(mock._str == "FFFF"); }
  WHEN("OCT") { mock.print(val, OCT); REQUIRE(mock._str == "177777"); }
  WHEN("BIN") { mock.print(val, BIN); REQUIRE(mock._str == "1111111111111111"); }
#elif (INT_MAX == 0x7FFFFFFF)
  WHEN("DEC") { mock.print(val, DEC); REQUIRE(mock._str == "-1"); }
  WHEN("HEX") { mock.print(val, HEX); REQUIRE(mock._str == "FFFFFFFF"); }
  WHEN("OCT") { mock.print(val, OCT); REQUIRE(mock._str == "37777777777"); }
  WHEN("BIN") { mock.print(val, BIN); REQUIRE(mock._str == "11111111111111111111111111111111"); }
#else
